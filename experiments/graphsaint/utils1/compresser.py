...
class Compresser(object):
    ...
    def compress(self, features, dn=None, batch_size=-1):
        self.batch_size = batch_size
        if dn:
            self.fn = "/home/Adama/GNN/quantized" + dn + "_" + self.mode + "_" + str(self.length) + "_" + str(self.width) + ".pkl"
        import os 
    ...
    def sq_compresser(self, features):
        ...
        perm = th.randperm(features.shape[0])
<<<<<<< HEAD:experiments/graphsaint/utils1/compresser.py
        sample = features[perm[:1000000]]
=======
        sample = features[perm[:100000]]
>>>>>>> 26476c3a6df8872af6618863d32dba09091e3a3f:graphsage/utils/compresser.py
...
if __name__ == "__main__":
    ...
    # print(features, compressed_features, decompressed_features)
