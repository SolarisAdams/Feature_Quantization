...
def evaluate(model, g, nfeat, labels, val_nid, device, compresser):
    ...
    with th.no_grad():
        ...
        dataloader = dgl.dataloading.NodeDataLoader(
            ...
            device=device,
            # device=None,
<<<<<<< HEAD:experiments/graphsage/train_compressed.py
            batch_size=10000,
=======
            batch_size=50,
>>>>>>> 26476c3a6df8872af6618863d32dba09091e3a3f:graphsage/train_compressed.py
            shuffle=False,
            drop_last=False,
            num_workers=0)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--num-epochs', type=int, default=61)
