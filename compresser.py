...
class Compresser(object):
    ...
    def compress(self, features, cache_root=None, dataset_name=None, batch_size=-1):
        """
        Parameters:
        ...
        if cache_root and dataset_name:
            self.fn = os.path.join(cache_root, dataset_name + "_" + self.mode + "_" + str(self.length) + "_" + str(self.width) + ".pkl")
